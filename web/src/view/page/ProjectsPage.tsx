  ...
  return (
    <>
      ...
      <BodyText>
        ...
        <Link href="https://github.com/rothfels/bespin">here</Link>.
      </BodyText>
    </>
  )
}
      ...
      <Table>
        ...
        <tbody>
          <Sprint
            ...
            checklist={[
              'get starter project',
              'follow Quickstart section until you have a running dev server',
              'learn React',
              'learn TypeScript',
              'learn git',
            ]}
...
function Sprint(props: { day: string; title: string; checklist?: string[] }) {
  return (
    <TR>
...
const TD = style('td', 'mid-gray pa2 v-mid', { minWidth: '7em' })
