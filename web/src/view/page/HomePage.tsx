        ...
        <LContent>
          ...
          <Section>
            ...
            <BodyText>
              <ul className="pl4">
                <li>
                  Download the <Link href="http://github.com/rothfels/bespin">starter project</Link> and follow the{' '}
                  <Link href="https://github.com/rothfels/bespin#quickstart">quickstart</Link> to configure your dev
                  environment.
                </li>
                <li>
